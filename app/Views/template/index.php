...
<head>
  ...
  <!-- link -->
  <link rel="shortcut icon" href="<?php echo base_url(); ?>/assets/dist/img/AL.png" alt="AL" height="60" width="60">
  <!--fontawesome-->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url(); ?>/assets/dist/img/AL.png" alt="AL" height="60" width="60">
  </div>
...
<div class="container-fluid">
  ...
  <footer class="main-footer">
    <strong>tugas uas<a href="https://adminlte.io">AL Store</a>.</strong>
    All rights reserved.
